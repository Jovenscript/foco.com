...
const SEED = {
  ...
  rotina: [
    ...
    { id:7,  titulo:'Remédio (você + Carol)',hora:'12:00',duracaoMin:5,   icone:'pill',     feito:false },
    { id:8,  titulo:'Almoço',               hora:'12:30', duracaoMin:45,  icone:'meal',     feito:false },
    { id:9,  titulo:'Sair pro WEG',         hora:'13:15', duracaoMin:0,   icone:'wrench',   feito:false },
    { id:10, titulo:'Turno WEG',            hora:'14:00', duracaoMin:600, icone:'wrench',   feito:false },
    { id:11, titulo:'Lanche da tarde',      hora:'16:00', duracaoMin:10,  icone:'meal',     feito:false },
    { id:12, titulo:'Jantar (refeitório)',  hora:'19:30', duracaoMin:30,  icone:'meal',     feito:false },
  ...
  eventos: [
    { id:1, nome:'PLR (lucro)',           mes:3,  regra:'2quarta', tipo:'entrada', valor:null },
    { id:2, nome:'PLR (lucro)',           mes:8,  regra:'2quarta', tipo:'entrada', valor:null },
    { id:3, nome:'13º · 1ª parcela',      mes:11, regra:'dia:30',  tipo:'entrada', valor:null },
    { id:4, nome:'13º · 2ª parcela',      mes:12, regra:'dia:20',  tipo:'entrada', valor:null },
    { id:5, nome:'Formatura (prima Carol)',mes:12, regra:'dia:4',  tipo:'saida',   valor:900 },
    { id:6, nome:'Documento / IPVA',      mes:5,  regra:'dia:15',  tipo:'saida',   valor:null },
    { id:7, nome:'Documento / IPVA',      mes:9,  regra:'dia:15',  tipo:'saida',   valor:null },
    { id:8, nome:'Imposto de renda',      mes:5,  regra:'dia:31',  tipo:'saida',   valor:null },
    { id:9, nome:'Nascimento da Laura',   mes:2,  regra:'dia:1',   tipo:'marco',   valor:null },
  ],
}
...
export function proximaOcorrencia(mes, regra){
  ...
  for(let y=hoje.getFullYear(); y<=hoje.getFullYear()+1; y++){
    let dia
    if(regra==='2quarta'){ const first=new Date(y,mes-1,1); const off=(3-first.getDay()+7)%7; dia=1+off+7 }
...
export function eventosOrdenados(dados){ return (dados.eventos||[]).map(e=>{const dt=proximaOcorrencia(e.mes,e.regra); return {...e,dt,dias:dt?diasAte(dt):9999}}).sort((a,b)=>a.dias-b.dias) }
